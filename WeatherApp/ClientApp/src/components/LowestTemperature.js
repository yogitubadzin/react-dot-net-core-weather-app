...
const LowestTemperature = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('cities/weathers/lowest-temperatures');
    ...
    plugins: {
      ...
      tooltip: {
        callbacks: {
          ...
          label: (tooltipItem) => `Temperature: ${tooltipItem.formattedValue}°C`,
        },
      },
    },
  };
...
export default LowestTemperature;
